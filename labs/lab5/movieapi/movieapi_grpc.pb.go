...
type MovieInfoClient interface {
	...
	SetMovieInfo(ctx context.Context, in *MovieData, opts ...grpc.CallOption) (*MovieStatus, error)
}
...
func (c *movieInfoClient) SetMovieInfo(ctx context.Context, in *MovieData, opts ...grpc.CallOption) (*MovieStatus, error) {
	out := new(MovieStatus)
...
type MovieInfoServer interface {
	...
	SetMovieInfo(context.Context, *MovieData) (*MovieStatus, error)
...
func (UnimplementedMovieInfoServer) SetMovieInfo(context.Context, *MovieData) (*MovieStatus, error) {
